...
const numerosX = [3,4,5,12,15].some(elem => elem > 10)
...
const numeros3 = [2,4,5].every(elem => elem > 0)
...
const persona = [{nombre:'luis',edad:23},{nombre:'carmen',edad:34}].find(elem => elem.edad > 30)
...
const palabras = ['papa','leche','alfajor','batata'].sort()
